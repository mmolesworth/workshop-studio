...
body {
  ...
  --color-background-slider-track-jsr5s6:var(--color-neutral-500-8van0b);
...
@media not print {
  .awsui-dark-mode:not(#\9) {
    ...
    --color-background-slider-track-jsr5s6:var(--color-neutral-600-fln1ww);
...
:root {
  --awsui-version-info-27dbde06: true;
}